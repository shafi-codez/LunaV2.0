...
public class AwsConsoleApp {
    ...
    public static void getCloudInfo() throws Exception {
        ...
        CREDPATH = "E:\\RESEARCH\\euca2-admin-x509\\eucarc";

        System.out.println("Getting cloud information from " + CREDPATH);
        ...
        System.out.println("EC2_ENDPOINT " + EC2_ENDPOINT);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Endpont set\n");
        ...
        try {
            ...
            System.out.println("You have " + instances.size() + " Amazon EC2 instance(s) reserved.");

            RunInstancesRequest runInstancesRequest = new RunInstancesRequest();

            runInstancesRequest.withImageId("emi-9BC33795")
                    .withInstanceType("m1.medium")
                    .withMinCount(1)
                    .withMaxCount(1)
                    .withKeyName("euca")
                    .withSecurityGroups("itm544");
            
            RunInstancesResult runInstancesResult = ec2.runInstances(runInstancesRequest);
            
            System.out.println("Result : "+runInstancesRequest.toString());
        ...
        /*         ObjectListing objects = s3.listObjects(bucket.getName());
         ...
         + "containing " + totalItems + " objects with a total size of " + totalSize / (1024 * 1024) + " Mbytes.");
         } catch (AmazonServiceException ase) {
         /*
